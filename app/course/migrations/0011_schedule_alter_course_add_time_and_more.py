...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('course', '0010_courseresource_isvideo_alter_course_add_time_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='course',
            name='add_time',
            field=models.DateTimeField(default=datetime.datetime(2022, 4, 5, 10, 36, 58, 608294), verbose_name='添加时间'),
        ),
        migrations.AlterField(
            model_name='courseresource',
            name='add_time',
            field=models.DateTimeField(default=datetime.datetime(2022, 4, 5, 10, 36, 58, 611292), verbose_name='添加时间'),
        ),
        migrations.AlterField(
            model_name='lesson',
            name='add_time',
            field=models.DateTimeField(default=datetime.datetime(2022, 4, 5, 10, 36, 58, 609294), verbose_name='添加时间'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='video',
            name='add_time',
            field=models.DateTimeField(default=datetime.datetime(2022, 4, 5, 10, 36, 58, 610294), verbose_name='添加时间'),
        ),
        migrations.AlterField(
            model_name='video',
            name='lesson',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='videos', to='course.lesson', verbose_name='所属章节'),
        ),
    ]
